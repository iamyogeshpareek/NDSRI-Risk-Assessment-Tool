...
Built as a portfolio project by an M.Pharm (Pharmaceutical Analysis) graduate working on AQbD-based analytical method development and a review article on NDSRIs covering FDA, EMA, and ICH M7(R2) frameworks.
